...
subst p6 p7; apply curve_elt_irr; clear H6 H7; 
 ...
 field [H1 H2 H3]; auto; repeat split; auto.
...
subst p6 p7; apply curve_elt_irr; clear H6 H7 H2b; 
  apply Keq_minus_eq; clear H4 H5; subst.
 field [H1 H2]; auto; repeat split; auto.
intros VV; field_simplify_eq[H1 H2] in VV.
case Hd3; symmetry; apply Keq_minus_eq;
  field_simplify_eq [H1 H2]; auto.
intros VV; field_simplify_eq[H1 H2] in VV.
...
subst p6 p7; apply curve_elt_irr; clear H6 H7;
 ...
 field [H2]; auto; repeat split; auto;
...
intros (x1,y1,z1,H1). 
unfold pdouble, pe2e.
case wb; intros b; case b; intros Hb; clear b; try rewrite Hb.
case wb; intros b; case b; intros Hb'; clear b; simpl; trivial.
apply False_ind; rewrite Hb in Hb'; discriminate.
unfold add.
...
case_eq (z1 ?0); intros.
case wb; intros b; case b; intros Hb1; clear b; auto.
apply False_ind; rewrite Hb in Hb1; discriminate.
apply False_ind; rewrite H in Hb1; discriminate.
case wb; intros b; case b; intros Hb1; clear b; auto.
